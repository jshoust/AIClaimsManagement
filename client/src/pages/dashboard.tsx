      ...
      <main className="flex-1 overflow-y-auto scrollbar-thin p-6">
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-medium text-[#2e7d32]">Dashboard</h2>
            <div className="flex gap-3">
              <Button 
                onClick={() => setIsCreateClaimModalOpen(true)}
                className="flex items-center gap-1 bg-[#2e7d32] hover:bg-[#266a2a]"
              >
              ...
              <Button 
                variant="outline"
                className="flex items-center gap-1 border-[#2e7d32] text-[#2e7d32] hover:bg-[rgba(46,125,50,0.05)]"
                onClick={() => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <SummaryCard
              ...
              icon={<span className="material-icons text-[#2e7d32]">description</span>}
              change={{ value: "3.2%", isPositive: true }}
              iconColor="bg-[rgba(46,125,50,0.1)]"
            />
